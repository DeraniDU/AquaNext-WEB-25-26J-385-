        ...
        <div className={styles.grid}>
          ...
          <div className={styles.infoPanel}>
            <div className={styles.infoCard}>
              ...
              <div>
                ...
                <p className={styles.infoText}>aquanext@my.sliit.lk</p>
              </div>
            </div>
          ...
          <form className={styles.form}>
            ...
            <div className={styles.formGroup}>
              ...
              <input type="text" id="contact-subject" name="subject" placeholder="Research collaboration" />
            </div>

            <div className={styles.formGroup}>
              <label htmlFor="contact-message">Message</label>
              <textarea id="contact-message" name="message" rows={5} required placeholder="Tell us about your inquiry..."></textarea>
            </div>
